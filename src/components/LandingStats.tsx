  ...
  return (
    <section className="section-gap">
      <div className="wrap grid gap-6 md:grid-cols-2">
        ...
        <div className="poster-card">
          <p className="micro-label">creators tipping</p>

          <ul className="mt-12 divide-y divide-[#f0efed] border-y border-[#e7e5e4]">
            {CREATORS.map((handle) => {
                ...
                >
                  <div className="flex min-w-0 items-center gap-4">
                    ...
                    <img
                      ...
                      height={44}
                      loading="lazy"
                      className="h-11 w-11 shrink-0 rounded-full border border-[#e7e5e4] object-cover"
                    />
                    <a
                  ...
                  <p className="shrink-0 tabular-nums">
                    <span className="amount-gold font-medium">
                      {stats ? usd(total ?? 0) : "—"}
                    </span>{" "}
