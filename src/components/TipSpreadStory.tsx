 ...
 * visualize value network — ink lines on white, one desaturated pastel
 * reserved for the travelling amount chips.
 */
...
const CHIPS: {
  ...
  { amount: "$12", node: 0, delay: "0s", duration: "6.2s" },
  { amount: "$19", node: 2, delay: "3.6s", duration: "5.5s" },
  { amount: "$28", node: 4, delay: "0.9s", duration: "5.8s" },
  { amount: "$47", node: 6, delay: "1.8s", duration: "6.6s" },
  { amount: "$64", node: 9, delay: "2.7s", duration: "7s" },
  { amount: "$73", node: 14, delay: "4.4s", duration: "5.4s" },
  { amount: "$81", node: 19, delay: "3.2s", duration: "6.8s" },
  { amount: "$100", node: 24, delay: "1.3s", duration: "6.1s" },
];

export function TipSpreadStory() {
  return (
    <section className="section-gap band section-pad">
      <div className="wrap">
        <p className="micro-label">the herd</p>
        ...
        <div className="card mt-16 px-4 py-10 sm:px-10">
          ...
          >
            ...
            {NODES.map((n, i) => (
              <circle
                ...
                cy={n.cy}
                r={n.r}
                fill={i % 11 === 0 ? "#0c0a09" : "#292524"}
                fillOpacity={i % 11 === 0 ? 0.9 : i % 7 === 0 ? 0.5 : 0.7}
